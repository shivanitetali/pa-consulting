...
//		
	...
	//created array list with the specified animal names
	...
	//add the specified animals to the already created array list
	...
	//removes Elephant from the array list
	...
	//removes all the animals from the ArrayList
